...
class MujocoEnv(gym.Env):
    ...
    def __init__(self, frame_skip, randomize: bool = False, phi: float = None, dist: str = None, samp: bool = False):
        ...
        if randomize:  # UDR and CDR parameters
            self.phi = phi
            self.dist = dist
